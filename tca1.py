...
def drawWCircle(img_draw,center,radius,sizes,minNodeSize,maxNodeSize):
    ...
    for k in range(len(points)):
        ...
        img_draw.text((x,y),str(k), fill='white')
...
def updateCorpusGraph(inpath,sizes):
    ...
    fnt = ImageFont.truetype('Arial',10)
...
class ViewerPanel(wx.Panel):
    ...
    def layout(self):
        ...
        img =wx.Image("images/graphImage.png")
        ...
        btn = wx.Button(self, label="choose manifold directory",size=(350,50))
        btn.Bind(wx.EVT_BUTTON,self.on_choose_folder)
        
        #imageLabel = wx.StaticText(self, label="")
        
        btn2 = wx.Button(self, label="create basic manifold report",size=(350,50))
        btn2.Bind(wx.EVT_BUTTON,self.on_choose_folder)
        
        
        
        self.mainSizer.Add(btn, 0, wx.ALL|wx.CENTER, 2)
        self.mainSizer.Add(btn2, 0, wx.ALL|wx.CENTER, 2)
