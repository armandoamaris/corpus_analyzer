...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 12 14:23:01 2023
...
path0="/Users/21e8/Desktop/PythonProjects/hdc-based-handwriting-Recognition/books/images/corpusGraph.png"
mazePath="/Users/21e8/Desktop/PythonProjects/hdc-based-handwriting-Recognition/books/maze2.png"
...
class ViewerFrame(wx.Frame):
    ...
    def __init__(self,page):
        """Constructor"""
        wx.Frame.__init__(self,page, title="TCA")
        #wx.Frame.__init__(self, None, title="TCA")
        panel = ViewerPanel(page)
        page.folderPath = ""
        #Publisher.subscribe(self.resizeFrame, ("resize"))
        
        #self.initToolbar()
        #page.Sizer = wx.BoxSizer(wx.VERTICAL)
        page.Sizer.Add(panel, 1, wx.EXPAND)
        #self.SetSizer(page.Sizer)
...
if __name__=="__main__":
    ...
    page2=TitlePage(wizard,"")
    
    """
    img = wx.Image(path0, wx.BITMAP_TYPE_ANY)
    ...
    frame = ViewerFrame(page2)
    page2.Sizer.Add(frame)
    ...
    # page3
    ########################################
    page3=TitlePage(wizard,"document reviewer")
    page3.Sizer.Add(wx.StaticText(page3,-1,"\n 1) annotation tool (next)"))
    page3.Sizer.Add(wx.StaticText(page3,-1,"\n 2) labelling tool (to build dataset for classification)"))
    page3.Sizer.Add(wx.StaticText(page3,-1,"\n \n \n"))
    button=wx.Button(page3,-1,"start review",pos=(400,50))
