...
class ViewerPanel(wx.Panel):
    ...
    def OnSubmit(self, event): 
      ...
      with open(self.reviewPath, "a") as outfile:
         outfile.write(wr)
      print("review was submitted 2")
      event.Skip()
    ...
    def on_choose_document(self, event):
        ...
        pics=[os.path.join(imagesPath, p) for p in ripaths]
        self.picPaths=sorted(pics)
        self.reviewPath=os.path.join(directory.split("/points")[0],"manifold","reviews.txt")
        print(self.reviewPath)
