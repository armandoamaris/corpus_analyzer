...
class ViewerPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.source="" #group corpus folder
        self.destination="" #blended corpus folder destination
    ...
    def on_blend(self, event):
        ...
        print("destination",self.destination)
        tf.mergeManifolds(self.source,self.destination)
